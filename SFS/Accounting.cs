...
namespace SFS
{
    class Accounting: Employee
    {
        ...
        public Accounting(int Expenses,string accountant, int n, string x, bool y, string z, string a, string d, string g, int i, bool m, float s, float b) : base(x,y,z,a,d,g,i,m,s,b)
        {
            expenses = Expenses;
