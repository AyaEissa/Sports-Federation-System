    ...
    class Containers
    {
        ...
        public static void Read_Players()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                Player p = new Player(tval, nvalue, dval, gval, int.Parse(ivalue), bool.Parse(medvalue), float.Parse(sval), float.Parse(bval));
                Player_list.Add(p);
            }
            w.Close();
        }
        public static void Read_Employees()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                Employee p = new Employee(edval, bool.Parse(aval), depval, nvalue, dval, gval, int.Parse(ivalue), bool.Parse(medvalue), float.Parse(sval), float.Parse(bval));
                Employee_list.Add(p);
            }
            w.Close();
        }
