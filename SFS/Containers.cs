...
namespace SFS
{
    class Containers
    {
        ...
        public static List<Championships_players> players = new List<Championships_players>();
        ...
        {
            Containers.players.Clear();
            XmlDocument doc = new XmlDocument();
            doc.Load("Results.xml");
            XmlNodeList list = doc.GetElementsByTagName("Results");
            BinaryFormatter f = new BinaryFormatter();
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                string results = list_2[2].Name;
                string reval = list_2[2].InnerText;

                //  Championships c = new Championships(ivalue, ctvalue, cpvalue,);
                //  championship_list.Add(c);
            }
            w.Close();
